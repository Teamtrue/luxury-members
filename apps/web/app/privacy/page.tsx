...
export const metadata = {
  ...
  description: `How ${brand.name} collects, uses, and protects your personal data under the DPDP Act 2023.`,
};
    ...
    <div style={pageStyle}>
      <div style={containerStyle}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <p style={pStyle}>
            {brand.legalName} ("{brand.name}", "we", "our", or "us") is committed to protecting
            your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard
            your information when you use the {brand.name} platform — including our website, mobile application,
        ...
        <ul style={ulStyle}>
          <li style={liStyle}><strong>Entity:</strong> {brand.legalName}</li>
          ...
          <li style={liStyle}><strong>Contact Email:</strong> {brand.privacyEmail}</li>
        </ul>
        ...
        <ul style={ulStyle}>
          <li style={liStyle}>Creating and managing your {brand.name} membership account</li>
          ...
          <li style={liStyle}>Calculating, crediting, and tracking {brand.tokenName}s</li>
        ...
        <ul style={ulStyle}>
          ...
          <li style={liStyle}>
            ...
            personal data. You can update most profile data directly in the {brand.name} app under Settings.
          </li>
          <li style={liStyle}>
        ...
        <p style={pStyle}>
          To exercise any of these rights, email {brand.privacyEmail} with the subject line "Data Rights
        ...
        <ul style={ulStyle}>
          ...
          <li style={liStyle}><strong>Email:</strong> {brand.privacyEmail}</li>
          <li style={liStyle}><strong>Address:</strong> {brand.legalName}, {brand.registeredAddress}</li>
        ...
        <p style={pStyle}>
          You have the right to delete your {brand.name} account and personal data. To do so:
        </p>
        <ul style={ulStyle}>
          <li style={liStyle}>
          ...
          <li style={liStyle}>
            <strong>By Email:</strong> Send a request to {brand.privacyEmail} with subject line
        ...
        <p style={pStyle}>
          Active memberships that are deleted will be subject to the refund policy at {brand.domain}/refund.
        </p>
        ...
        <p style={pStyle}>
          The {brand.name} Platform is not intended for individuals under the age of 18. We do not knowingly
        ...
        <p style={pStyle}>
          ...
          contact us at {brand.privacyEmail} and we will take immediate corrective action.
        </p>
        ...
        <ul style={ulStyle}>
          ...
          <li style={liStyle}><strong>Postal Address:</strong> {brand.legalName}, {brand.registeredAddress}</li>
        </ul>
