...
const TIER_TABLE = [
  ...
  { tier: 'Gold', color: 'var(--gold)', multiplier: '1.25×', earn: '1.25% of purchase', redeem: '20%', expire: '18 months' },
  { tier: 'Platinum', color: '#b0c4d8', multiplier: '1.5×', earn: '1.5% of purchase', redeem: '30%', expire: '24 months' },
  { tier: 'Obsidian', color: 'var(--gold)', multiplier: '2.0×', earn: '2% of purchase', redeem: '50%', expire: '36 months' },
];

const HOW_EARN = [
  { icon: '🛒', title: 'Purchase Deals', desc: `Earn 1–2% of every transaction as ${brand.tokenName}s based on your tier.` },
  { icon: '👥', title: 'Refer Friends', desc: `Get 500 ${brand.tokenName} bonus when a referred member makes first purchase.` },
  { icon: '⭐', title: 'Trail Commissions', desc: 'Earn 2% of every purchase your referrals make, credited as tokens.' },
  { icon: '🎁', title: 'Renewal Bonuses', desc: `Receive bonus tokens on membership renewal — 2,000 ${brand.tokenName}s for Platinum.` },
];

const HOW_REDEEM = [
  { icon: '💰', title: 'At Checkout', desc: `Use slider during booking — apply up to 30% of order value in ${brand.tokenName}s.` },
  { icon: '🔄', title: 'Token Rate', desc: `1 ${brand.tokenName} = ₹${brand.tokenValueInINR} redemption value.` },
  { icon: '⏱', title: 'Validity', desc: `Platinum ${brand.tokenName}s are valid for 24 months from date of credit.` },
