...
export const brand = {
  ...
  grievanceEmail:'grievance@plutusclub.in',

  // ── Grievance Officer (DPDP Act / consumer protection compliance) ─────────
  grievanceOfficer: {
    name:  'Grievance Officer',          // PLACEHOLDER — replace with named individual before go-live
    email: 'grievance@plutusclub.in',
    phone: '+91-22-0000-0000',           // PLACEHOLDER
    address: 'PlutusClub, Mumbai, Maharashtra — 400001',
    responseWindowHours: 48,
    resolutionWindowBusinessDays: 15,
  },
