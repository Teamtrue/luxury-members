...
// ── Stack param list (includes nested screens) ───────────────────────────────
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => (
          <Ionicons
            name={getTabIcon(route.name as keyof MemberTabParamList, focused)}
            size={size}
            color={color}
          />
        ),
    ...
    >
      <Tab.Screen
        ...
        options={{ title: 'Home', headerTitle: brand.name }}
      />
      <Tab.Screen
        name="Deals"
        component={DealsScreen}
        options={{ title: 'Deals', headerTitle: 'All Deals' }}
      />
      <Tab.Screen
        name="Wallet"
        component={WalletScreen}
        options={{ title: 'Wallet', headerTitle: `${brand.tokenName}s` }}
      />
      <Tab.Screen
        name="Referral"
        component={ReferralScreen}
        options={{ title: 'Refer', headerTitle: 'Referrals' }}
      />
      <Tab.Screen
        name="Settings"
