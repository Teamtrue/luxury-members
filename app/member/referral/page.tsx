...
export default function ReferralPage() {
  ...
  function shareWhatsApp() {
    ...
    const msg = encodeURIComponent(
      `Hey! I'm part of PlutusClub — India's private group buying club. Get exclusive prices on electronics, cars, travel & more. Use my code ${code} to join: https://plutusclub.in/join`
    );
